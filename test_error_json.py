...
if __name__ == "__main__":
    ...
    normal_simulation_once(
        [
            {
                'instance_type': 'cube', 
                'cube_param': [0.24886469535882882, 0.17633462214617635, 0.22819142212103127], 
                'material': 'plasticine', 
                'center': [0.47848216762853374, 0.8076253465575405, 0.6872385381427923]
            }, 
            {
                'instance_type': 'mesh', 
                'path': './assets/objs/carrot.obj', 
                'cube_param': [0.1744301676699369, 0.24654649004812662, 0.24982780505441515], 
                'material': 'fluid', 
                'center': [0.7586201784890799, 0.558749109103391, 0.7448660928729378]
            },
            {
                'instance_type': 'cube', 
                'center': (0.5, 0.23823396556283877, 0.5), 
                'cube_param': (0.9, 0.2764679311256775, 0.9), 
                'material': 'sand'
            }
        ],
