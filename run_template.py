...
def normal_simulation_once(
    ...
    **kwargs
    ...
    head_writer = imageio.get_writer(f'{save_root}/{scene_name}/movie.mp4', fps=24)
    left_writer = imageio.get_writer(f'{save_root}/{scene_name}/left.mp4', fps=24)
    right_writer = imageio.get_writer(f'{save_root}/{scene_name}/right.mp4', fps=24)
